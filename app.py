...
def build_sidebar():
    st.image("/workspaces/python_para_investidores/images/logorea.png")
...
def build_main(tickers, prices):
    ...
    for t in prices.columns:
        ...
        if t == "portfolio":
            colA.image("/workspaces/python_para_investidores/images/pie-chart-dollar-svgrepo-com.svg")
        elif t == "IBOV":
            colA.image("/workspaces/python_para_investidores/images/pie-chart-svgrepo-com.svg")
        else:
